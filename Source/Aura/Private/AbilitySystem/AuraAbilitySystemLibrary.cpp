                                                                        ...
                                                                        ULoadScreenSaveGame* SaveGame)
{
	...
	// 根据SaveGame设置Primary Attributes标签设置对应的Magnitude
...
void UAuraAbilitySystemLibrary::SetRadialDamageEffectParam(FDamageEffectParams& DamageEffectParams, const bool bIsRadial, const float InnerRadius,
...
ULootTiers* UAuraAbilitySystemLibrary::GetLootTiersInfo(const UObject* WorldContextObject)
{
	const AAuraGameModeBase* AuraGameMode = Cast<AAuraGameModeBase>(UGameplayStatics::GetGameMode(WorldContextObject));
	if (AuraGameMode == nullptr)
	{
